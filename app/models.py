...
class BuildingConsumption(models.Model):
    ...
    house_consumption = models.DecimalField(max_digits=10, decimal_places=2)
    ground_floor_consumption = models.DecimalField(max_digits=10, decimal_places=2)
    attic_consumption = models.DecimalField(max_digits=10, decimal_places=2)
    basement_consumption = models.DecimalField(max_digits=10, decimal_places=2)
    heating_consumption = models.DecimalField(max_digits=10, decimal_places=2)
